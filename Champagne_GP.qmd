...
# TODO
- Constrain the variables to be positive
...
amplitude_champ = tf.Variable(150., dtype=np.float64, name="amplitude_champ")
# length_scale_champ = tf.Variable(0.02, dtype=np.float64, name="length_scale_champ")
observation_noise_variance_champ = tf.Variable(
    1000., dtype=np.float64, name="observation_noise_variance_champ"
)
```
