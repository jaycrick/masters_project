...
plt.plot(lls_)
plt.title("GP hyperparameters fitting")
plt.xlabel("Training iteration")
plt.ylabel("Log likelihood")
plt.savefig("champagne_GP_images/hyperparam_loss_NO_BOLFI.pdf")
plt.show()
```
...
plt.savefig("champagne_GP_images/alpha_slice_NO_BOLFI.pdf")
plt.show()
```
...
plt.savefig("champagne_GP_images/beta_slice_NO_BOLFI.pdf")
plt.show()
```